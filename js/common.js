...
window.langCommon = {
  ru: {
    ...
    menuFooterText: "Благодарим за бесценную помощь:<br>Антанаса Яциневичюса<br>Юлию Алерт<br>Артема Арсеняна"
  },
  de: {
    headerTitle: "BuschKunstTheater",
    headerSubtitle: "UberZauberBerg",
    ...
    menuFooterText: "Wir sind dankbar für die unschätzbare Hilfe von:<br>Antanas Jacinevicius<br>Julia Ahlert<br>Artem Arsenyan"
  },
  en: {
    headerTitle: "BuschKunstTheater",
    headerSubtitle: "UberZauberBerg",
    ...
    menuFooterText: "We are grateful for the invaluable assistance of:<br>Antanas Jacinevicius<br>Julia Ahlert<br>Artem Arsenyan"
  }
};
